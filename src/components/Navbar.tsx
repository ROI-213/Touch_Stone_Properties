        ...
        <AnimatePresence>
          {!hidden && (
            <motion.header
              ...
              className="pointer-events-auto flex w-full items-center justify-between gap-3 rounded-[18px] border border-black/[0.06] bg-white px-3 py-2 shadow-[0_8px_30px_rgba(0,0,0,0.08)] sm:px-5"
            >
              {/* Left: Logo */}
