...
export async function createProperty(input: PropertyInsert) {
  ...
  // If a staff member is creating this property and no staff is assigned,
  // auto-assign it to themselves so the Enquire button is wired up by default.
  ...
  if (!assigned_staff_id) {
    ...
    } catch { /* ignore — admins without staff record fall through */ }
  }
